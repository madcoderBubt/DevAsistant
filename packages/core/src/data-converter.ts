 ...
 */
export function jsonToCsv(jsonString: string): ConversionResult {
    try {
        const jsonData = JSON.parse(jsonString);
 ...
 */
export function csvToJson(csvString: string): ConversionResult {
    try {
 ...
 */
export function xmlToCsv(xmlString: string): ConversionResult {
    try {
 ...
 */
export function csvToXml(csvString: string): ConversionResult {
    try {
